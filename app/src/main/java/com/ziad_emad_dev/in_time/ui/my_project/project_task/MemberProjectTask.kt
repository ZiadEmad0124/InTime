...
import com.ziad_emad_dev.in_time.databinding.ActivityMemberProjectTaskBinding
...
class MemberProjectTask : AppCompatActivity() {

    private lateinit var binding: ActivityMemberProjectTaskBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMemberProjectTaskBinding.inflate(layoutInflater)
    ...
    private fun showPopupMenu(view: View) {
        ...
        popupMenu.menuInflater.inflate(R.menu.project_task_member_menu, popupMenu.menu)
    ...
    private fun stopLoading(message: String) {
        if (message == "true") {
            ...
            binding.noConnection.setOnClickListener {
                ...
                val task: Task = intent.getParcelableExtra("projectTask")!!
                getTask(task.id)
            }
        }
    }
